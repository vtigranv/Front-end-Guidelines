...
## Table of Contents
  ...
  1. [HTML](#html)  ![HTML](https://img.shields.io/badge/-HTML-e24e30.svg)
  ...
  1. [Remove .col-md-X and .col-lg-X if .col-sm-X has same value for X](#remove-col-md-x-and-col-lg-x-if-col-sm-x-has-same-value-for-x--) 
  1. [Don’t use .col-xs-12](#dont-use-col-xs-12--) 
